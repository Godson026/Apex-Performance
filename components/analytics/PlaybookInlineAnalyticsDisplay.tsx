...
import { 
    Playbook, Trade, TradeOutcome, EquityDataPoint, MarketEnvironment, TradingSession, 
    PerformanceMetrics, TradeDurationDetails, ConfidenceScore, EmotionalState,
    PlaybookPsychologicalProfile, PlaybookEnvPerformance, RollingPerformanceDataPoint
} from '../../types';
import { ResponsiveContainer, LineChart, Line, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, PieChart, Pie, Cell, ComposedChart } from 'recharts';
import { ICONS, getValueColorClasses } from '../../constants';
import { MARKET_ENVIRONMENT_OPTIONS, TRADING_SESSION_OPTIONS, EMOTIONAL_STATE_OPTIONS } from '../../constants';
...
const PIE_COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#8884D8', '#A2D2FF', '#FF8FAB'];
